      ...
      <div className="w-full max-w-md bg-white rounded-3xl p-6 sm:p-10 shadow-sm border border-gray-100">
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4 animate-in fade-in">
          ...
          <div className="flex justify-end pt-1">
            <Link href="/forgot-password" className="text-sm font-bold text-gray-500 hover:text-brand-orange transition-colors">
              Forgot Password?
            </Link>
          </div>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-brand-blue text-white py-4 rounded-xl font-bold text-[16px] hover:bg-blue-700 transition-all shadow-md active:scale-95 disabled:opacity-50 mt-2 flex justify-center items-center gap-2"
          >
